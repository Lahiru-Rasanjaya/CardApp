...
class Revision extends StatefulWidget {
  ...
  @override
  State<Revision> createState() => _TheoryState();
}

class _TheoryState extends State<Revision> {
  ...
  final CollectionReference<Map<String, dynamic>> attendanceRef =
      FirebaseFirestore.instance.collection('attendanceRevision');
